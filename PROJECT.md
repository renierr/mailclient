...
| 5 | Polish: background IDLE/polling sync, offline/error states, onboarding, `.desktop`/icons, Windows feasibility | ⬜ planned (auto-check timer done, manual ⟳ kept; IDLE not yet) |
