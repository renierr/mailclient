...
class MailCoreApiWire implements BaseWire {
  MailCoreApiWire.fromExternalLibrary(ExternalLibrary lib);
}

@JS('wasm_bindgen')
external MailCoreApiWasmModule get wasmModule;

@JS()
@anonymous
extension type MailCoreApiWasmModule._(JSObject _) implements JSObject {}
