...
BarWidget {
    ...
    function saveAccountFilter(rawText) {
        ...
        if (value !== mail.account)
            root.saveSetting("account", value);
    }
    ...
    function heroMeta() {
        ...
        if (mail.unread > 1)
            return mail.unread + " unread messages";
            ...
            Column {
                    ...
                    Repeater {
                        ...
                        BorderSurface {
                            ...
                            color: entryMouse.pressed ? Style.pressedFillFor(root.panelForeground, Color.accent) :
                                                        entryMouse.containsMouse ? Style.hoverFillFor(
                            ...
                            PanelToolTip {
                                ...
                                text: (Model.clean(modelData.from) || "(unknown)") + " — " + (Model.clean(
                                                                                                  modelData.subject)
                                                                                              || "(no subject)")
                                fontFamily: root.panelFontFamily
                            }
                ...
                NumberField {
                    ...
                    onModified: function (v) {
                        root.saveSetting("syncIntervalMin", v);
                    }
                }
